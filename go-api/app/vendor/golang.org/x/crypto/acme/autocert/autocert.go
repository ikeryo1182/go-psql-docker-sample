...
// Package autocert provides automatic Account to certificates from Let's Encrypt
...
// The returned error is Accountible via tls.Conn.Handshake and its callers.
