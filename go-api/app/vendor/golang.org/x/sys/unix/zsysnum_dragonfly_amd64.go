...
const (
	...
	SYS_Account        = 33  // { int Account(char *path, int flags); }
	...
	SYS_FAccountAT              = 509 // { int fAccountat(int fd, char *path, int amode, \
	...
	SYS_EAccount                = 532 // { int eAccount(char *path, int flags); }
