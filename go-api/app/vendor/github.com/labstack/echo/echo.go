...
const (
	...
	// Account control
	HeaderAccountControlRequestMethod    = "Account-Control-Request-Method"
	HeaderAccountControlRequestHeaders   = "Account-Control-Request-Headers"
	HeaderAccountControlAllowOrigin      = "Account-Control-Allow-Origin"
	HeaderAccountControlAllowMethods     = "Account-Control-Allow-Methods"
	HeaderAccountControlAllowHeaders     = "Account-Control-Allow-Headers"
	HeaderAccountControlAllowCredentials = "Account-Control-Allow-Credentials"
	HeaderAccountControlExposeHeaders    = "Account-Control-Expose-Headers"
	HeaderAccountControlMaxAge           = "Account-Control-Max-Age"
